      ...
      <div className="about">
        <h2>The Fine Details</h2>
          ...
          <p>
            ...
            <p>We utilize the USDA's <a href='https://fdc.nal.usda.gov/api-guide.html'>FoodData Central API</a> for all food and ingredient data. Citation: U.S. Department of Agriculture, Agricultural Research Service. FoodData Central, 2019. fdc.nal.usda.gov.</p>
      </div>
    </section>
  );
}
